...
INSERT INTO student(id,name,email,parent_name,parent_email,address)
VALUES
...
INSERT INTO school(id,name,address,type,Title_I,principal)
VALUES
(1, 'Navy', '1111 New Court Lane', 'E', 0, 'John'),
(2, 'Rocky Run', '1234 New Court Lane', 'M', 1, 'Sarah');

INSERT INTO study(student_id,school_id)
VALUES
(1, 1),
(2, 1),
(3, 2);

INSERT INTO kit(id,type,name)
VALUES
(1, 'ES', 'Create an air cannon'),
(2, 'MS', 'Build a volcano');

INSERT INTO purchase(student_id,kit_id, amount)
VALUES
(1, 2, 5),
(2, 1, 3),
(3, 2, 4);

INSERT INTO part(id,name,price,manufacturer)
VALUES
(1, 'Styrofoam', 10, 'Amazon'),
(2, 'Cardboard Box', 15, 'Home Depot'),
(3, 'Play-Doh', 5, 'Toys-R-Us');

INSERT INTO assembly(kit_id,part_id,amount)
VALUES
(1, 1, 2),
(1, 2, 3),
(2, 1, 5),
